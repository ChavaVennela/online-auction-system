...
<head>
<meta charset="UTF-8">
<title>Similar-Items-Page</title>
...
<body>
	...
	<div>
		...
		<div class="main">
		<p>Please find Similar Products from preceding month here:</p>
			<% try {
					...
					ResultSet result = stmt.executeQuery("select Itemname from ItemDetails where Itemid<>'" + Itemid + "' and category='"+category+"'");
				%>	
			<table id="Bids">
				<tr>
					<th>Product Name</th>
