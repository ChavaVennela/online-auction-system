		...
		<div class="main">
			...
			<table id="bids">
				...
				<tr>
					...
					<td><a href="deletebid.jsp?Itemid=<%= Itemid %>&username=<%= result.getString("username") %>&price=<%= result.getString("pricelist") %>" id="submit" class="btn btn-primary">Delete</a></td>
				</tr>
			<% } %>
			</table>
			<p><button onclick="location.href='AdminProductsPage.jsp?Itemid=<%= Itemid %>'" style="padding: 10px 25px;margin: 10px 2px;" type="button" class="btn btn-primary">Go Back</button></p>
